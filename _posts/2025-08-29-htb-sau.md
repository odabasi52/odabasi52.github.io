...
summary: "Identified request-baskets v1.2.1 vulnerable to CVE-2023-27163 SSRF, exploited SSRF to access internal Maltrail v0.53 service, discovered Maltrail RCE vulnerability and exploited for reverse shell, gained puma user access, discovered sudo privilege to run systemctl status trail.service, exploited systemctl GTFOBins technique (less pager !sh) to gain root shell."
---
