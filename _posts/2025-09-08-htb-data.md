---
layout: post
title: "Data - Hack The Box"
summary: "Grafana CVE-2021-43798 path traversal → sqlite database extraction via curl → grafana2hashcat hash format conversion → hash cracking (boris credentials) → sudo docker exec privilege escalation → /dev/sda1 mount access → host root filesystem access"
---
