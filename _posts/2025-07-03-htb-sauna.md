...
summary: "Website user list → username-anarchy (username anarchy) → AS-REP Roasting → crack hash → user shell → AutoLogon Credentials → service account → DCSync → Administrator"
---
