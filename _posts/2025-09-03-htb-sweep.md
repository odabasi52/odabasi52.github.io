---
layout: post
title: "Sweep - Hack The Box"
summary: "SMB null session RID brute-force → intern:intern credentials → Lansweeper web access → SSH honeypot to capture service account credentials → BloodHound enumeration → Lansweeper Admins group membership → administrative shell via deployment function"
---
